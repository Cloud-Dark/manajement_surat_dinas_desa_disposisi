								...
								<tbody id="isi">
									...
									<tr>
										...
										<td>
											...
											<a href="<?php echo base_url('kasubag/delmasuk/'.$key->id_smasuk) ?>" class="btn btn-outline-danger" data-toggle="tooltip" onclick="return confirm('Hapus surat masuk?')" title="Hapus Surat Masuk"><i class="fa fa-trash"></i></a>
